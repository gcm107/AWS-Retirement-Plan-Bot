...
def recommend_portfolio(intent_request):
    ...
    # Validate that the user is older than 0 and less than 65 years old
    if age is not None:
    ...
    if investment_amount is not None:
        ...
        if investment_amount >= 5000:
            return build_validation_result(
                ...
                "please provide a correct investment_amount.",
            )
    
    
    if risk_level == "None":
        message = "None: 100% bonds (AGG), 0% equities (SPY)"
    elif risk_level == "Low":
        message = "Low: “60% bonds (AGG), 40% equities (SPY)"
    elif risk_level == "Medium":
        message = "Medium: “40% bonds (AGG), 60% equities (SPY)"
    elif risk_level == "High":
        message = "High: “20% bonds (AGG), 80% equities (SPY)"
    return (message)
